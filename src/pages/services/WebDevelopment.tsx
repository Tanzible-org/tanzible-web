...
const capabilities = [
  ...
  },
  {
    ...
    description:
      "Lightning-fast applications with optimized code and efficient database queries.",
  },
  {
    icon: Shield,
    title: "Security First",
    description:
      "Robust security measures to protect your data and user information.",
  },
  {
    icon: Globe,
    title: "Scalable Architecture",
    description:
      "Built to grow with your business, handling increased traffic and data.",
  },
  {
    icon: Smartphone,
...
const technologies = [
  ...
  {
    name: "Python",
    description: "Versatile language for complex applications",
  },
...
const processSteps = [
  {
    ...
    description:
      "Understanding your requirements, target audience, and business goals.",
    timeline: "1-2 weeks",
  },
  {
...
const WebDevelopment = () => {
  return (
    <>
      ...
      <section className="relative min-h-[80vh] flex items-center overflow-hidden px-4 sm:px-6 lg:px-8">
        {/* Background video */}
        <div className="absolute inset-0 -z-10">
          ...
          >
            ...
            <source src="/assets/webdev-hero.mp4" type="video/mp4" />
          </video>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-white/85 mb-8 leading-relaxed">
                Build robust, scalable web applications that grow with your
                business. From simple websites to complex enterprise solutions.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                <Link to="/work">
                  <Button
                    variant="outline"
                    className="glass-card border-white/30 text-white bg-white/10 px-8 py-3 rounded-xl text-lg font-semibold"
                  >
                    View Our Work
                  </Button>
                </Link>
            ...
            {/* Right: keep your glass card highlights, now on top of the video */}
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-black/80 max-w-3xl mx-auto">
              Comprehensive web development services covering every aspect of
              your project.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {capabilities.map((capability, index) => (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="glass-card rounded-xl bg-[#f0eee8] p-6 group"
              >
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-card/30">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-black/80 max-w-3xl mx-auto">
              A proven methodology that ensures quality delivery and transparent
              communication.
            </p>
          </motion.div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/contact">
                <Button
                  ...
                  // className="border-white/30 text-white bg-accent hover:bg-accent/90 px-8 py-3 rounded-xl text-lg font-semibold hover:scale-105"
                >
